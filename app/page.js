...
const copy = {
  id: {
    ...
    about:
      "Siswa aktif dan antusias jurusan Teknik Komputer dan Jaringan di SMKN 1 Blitar dengan minat besar pada pengembangan web dan infrastruktur IT. Terampil dalam pengembangan frontend, manajemen proyek, serta desain UI/UX. Memiliki pengalaman nyata dalam membangun proyek seperti platform e-commerce dan desain portofolio freelance untuk klien internasional. Mampu berkomunikasi dalam Bahasa Inggris (bersertifikat TOEIC) dan bersemangat untuk menambah pengalaman profesional melalui program magang.",
  },
  en: {
    role: "Web Developer",
    heroTitle: "Hi, I'm ",
    ...
    about:
      "Enthusiastic and active Computer and Network Engineering student at SMKN 1 Blitar with strong interest in web development and IT infrastructure. Skilled in frontend development, project management, and UI/UX design. Proven experience in building real projects such as e-commerce platforms and freelance portfolio designs for international clients. Able to communicate in English (TOEIC certified) and eager to gain more professional experience through internship.",
  },
};
...
export default function Portfolio() {
  ...
  const profile = {
    ...
    cvUrl:
      "https://drive.google.com/file/d/1MVBz4G91_RjSJxoSiIorOV_0jegWpzjC/view?usp=sharing",
  };
  ...
  const experiences = [
    {
      ...
      role:
        lang === "id"
          ? "Ketua Panitia Diesnatalis 59"
          : "Chairman of Diesnatalis 59 Committee",
      date: "2025",
      points:
        lang === "id"
          ? [
  ...
  return (
    <div className="min-h-screen bg-black text-neutral-100 selection:bg-yellow-400/30 selection:text-yellow-900">
        ...
        <div className="grid md:grid-cols-3 gap-6 items-center">
          <motion.div
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              <Badge
                variant="outline"
                className="border-yellow-600/60 text-yellow-400">
                JavaScript
              </Badge>
              <Badge
                variant="outline"
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              {contacts.map((c, i) => (
                <a
                  key={i}
                  href={c.href}
                  className="inline-flex items-center gap-2 px-3 py-2 rounded-2xl border border-yellow-700/40 hover:border-yellow-400/80 transition">
                  {c.icon}
            ...
            <CardContent className="space-y-8">
              ...
              <div>
                ...
                <ul className="grid grid-cols-2 gap-2 text-neutral-300">
                  ...
                  <li>
                    Network Engineering: LAN/WLAN installation & troubleshooting
                  </li>
                ...
                <ul className="space-y-3 text-neutral-300">
                  <li>
                    ...
                    <p className="text-neutral-400 text-sm">
                      Joined IT extracurriculars, represented school in science
                      & technology competitions.
                    </p>
                  </li>
                  <li>
                    <b>
                      SMKN 1 Blitar – Computer and Network Engineering (TKJ)
                    </b>
                    <p className="text-neutral-400 text-sm">
                      Relevant Courses: Networking, Security, Web Dev, Database,
                      OS, Troubleshooting. Projects: LAN classroom system,
                      Smekenshop E-Commerce app, lab maintenance, local web
                      design competitions.
                    </p>
                  </li>
                </ul>
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    {p.tech.map((t) => (
                      <Badge
                        key={t}
                        variant="outline"
                        className="border-yellow-700/50 text-yellow-300">
                        {t}
                      </Badge>
                    ))}
                  </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid gap-4">
          {experiences.map((e) => (
            <Card
              key={e.org}
              className="bg-neutral-900/60 hover:bg-gradient-to-bl hover:scale-[102%] transition-all from-yellow-500 to-yellow-800 border-yellow-700/30 rounded-2xl">
              <CardHeader>
        ...
        <div className="grid md:grid-cols-2 gap-6 items-start">
          <div>
            ...
            <p className="text-neutral-300 mb-3">
              {lang === "id"
                ? "Terbuka untuk proyek freelance, magang, atau kolaborasi."
                : "Open for freelance, internship, or collaboration."}
            </p>
            <div className="space-y-2">
              {contacts.map((c, i) => (
                <a
                  key={i}
                  href={c.href}
                  className="flex items-center gap-2 text-neutral-300 hover:text-yellow-300">
                  {c.icon}
                  <span>{c.label}</span>
                </a>
              ))}
          ...
          <Card className="bg-neutral-900/60 border-yellow-700/30 rounded-2xl">
            <CardHeader>
              <CardTitle className="text-slate-200">
                {lang === "id" ? "Kirimkan Pesan" : "Send a Message"}
              </CardTitle>
              <CardDescription className="text-neutral-400">
                {lang === "id"
                  ? "Saya akan menghubungi balik secepat mungkin"
            ...
            <CardContent>
              <div className="space-y-3">
                <Input
                  ...
                  className="rounded-xl bg-neutral-950 border-yellow-800/40"
                />
                <Input
            ...
            <CardFooter>
              <a href="mailto:ardankerja@gmail.com">
                <Button className="bg-yellow-500 hover:bg-yellow-400 text-black rounded-2xl w-full">
                  {t.formSend}
                </Button>
              </a>
            </CardFooter>
      ...
      <footer className="border-t border-yellow-700/20 py-6 text-center text-sm text-neutral-400">
        ...
        {lang === "id" ? "Dibuat dengan" : "Built with"} ❤️
      </footer>
    </div>
  );
}
